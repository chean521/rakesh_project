...
<script src="../../Js/QuotationSubmit_Reqs.js"></script>
...
$(document).ready(function(e){
   $('#btn_Create_Close').click(function(f){
       ...
       $('#Desc_Container tbody').children().remove();
   }); 
        ...
        <div class="modal-dialog modal-lg" >
            <div class="modal-content" style="background-color: rgba(255,255,255,0.7);">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="InvoiceNo" class="control-label col-md-5">Quotation No</label>
                                <label for="InvoiceDate" class="control-label col-md-6">Quotation Date</label>
                                <div class="input-group">
                                    <input type="text" id="InvoiceNo_Minified" class="form-control col-md-5" placeholder="Quotation No" onfocus="ReleaseWhite(this);" disabled="disabled"/>
                                    <input type="date" id="InvoiceDate" placeholder="Quotation Date" class="form-control col-md-7" onfocus="ReleaseWhite(this);"/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" id="AttnName"  maxlength="50" placeholder="Attn Name" class="form-control" onfocus="ReleaseWhite(this);"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-primary" id="panel_desc">
                                    <div class="panel-heading">
                                        <div class="row">
                                            <div class="col-md-10">Quotation Description (Max: <strong id="count">0</strong> / 10)</div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" id="btn_Create_Submit" onclick="SubmitQuotation_Statement(<?php echo $Sess_UserID; ?>);" >Create New Quotation</button>
