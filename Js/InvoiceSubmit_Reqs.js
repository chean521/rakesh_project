...
function SubmitInvoice_Statement(CompanyId){
    var InvoiceId = $('#InvoiceNo');
    var InvoiceDate = $('#InvoiceDate');
    var CustomerID = $('#CustomerID');
    var QuotationNo = $('#QuotationNo');
    var Terms = $('#Terms');
    ...
    if(isFormMissing === true){
        ...
        var conf = confirm("Are you sure want to proceed? Once proceed cannot been revert back.");
            ...
            xmlhttp.onreadystatechange = function(e){
                if(this.readyState === 4 && this.status === 200){
                    ...
                    if(resp.Result === "true"){
                        ...
                        alert("Invoice not created, please contact with administrator.");
                    }
                }
            };
            
            xmlhttp.open("POST", "/WBServices/NewInvoiceSubmit_Resp.php", true);
